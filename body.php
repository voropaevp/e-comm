      ...
      <span class="sr-only">Next</span>
		...
		<div class="section">
			...
			<div class="container">
				...
				$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id ORDER BY `products`.`product_id`  DESC LIMIT 5";
