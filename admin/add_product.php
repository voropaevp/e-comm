...
<h3>Category</h3>
<p>Genre</p>
<input type="number" name="product_type" id="product_type" class="form-control" placeholder="1-Modern, 2-Retro, 3-Musicals, 4-Romance, 5-Comedy, 6-Collection, 7-Action">
<br>
<p>DVD / Blueray</p>
<input type="number" name="brand" id="brand" class="form-control" placeholder="1 DVD,2 Blueray">
<br>
<p>Other tags</p>
<input type="text" name="tags" id="tags" class="form-control"
 placeholder="Kira Knigthley, tags">
</div>
</div>
