...
<!-- <li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='manage_users.php'"><span class="glyphicon glyphicon-edit pull-left"></span> Customers </button></li>
 -->
  <li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-primary" onClick="location.href='orders.php'"> <span class="glyphicon glyphicon-edit pull-left"></span> Orders </button></li>
  ...
  <ul class="dropdown-menu" style="width:240px">
    <li><a href="blueray_list.php"><strong>Blueray List</strong> </a></li>
 <li><a href="dvd_list.php"><strong>DVD List</strong></a></li>
   </ul></li>
